...
set_property MARK_DEBUG true [get_nets execute]
set_property MARK_DEBUG true [get_nets inference_0/app_rd_data_valid]
set_property MARK_DEBUG true [get_nets {hex_gridB_OBUF[0]}]
set_property MARK_DEBUG true [get_nets {hex_gridB_OBUF[1]}]
set_property MARK_DEBUG true [get_nets {hex_gridB_OBUF[2]}]
set_property MARK_DEBUG true [get_nets {hex_gridB_OBUF[3]}]
